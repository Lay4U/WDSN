					...
					<div class="col-9 col-9-medium imp-medium">
						...
						<div class="container">
							<div class="row">
								<table class="table table-striped"
									...
									<tbody>
										<%
											BbsDAO4 BbsDAO42 = new BbsDAO4();
											ArrayList<Bbs> list = BbsDAO42.getList(pageNumber);
						...
						+ list.get(i).getBbsDate().substring(14, 16) + "분 "%></td>
								...
								<%
									if (pageNumber != 1) {
								%>
								<a href="game.jsp?pageNumber=<%=pageNumber - 1%>"
									class="btn btn-success btn-arraw-left">이전</a>
								<%
									}
									if (BbsDAO42.nextPage(pageNumber + 1)) {
								%>
								<a href="game.jsp?pageNumber=<%=pageNumber + 1%>"
