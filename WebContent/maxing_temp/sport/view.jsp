...
<body>
	<% 
		...
		if (bbsID == 0) {
			...
			script.println("location.href = 'sport'");
			script.println("</script>");
		}
		Bbs bbs = new BbsDAO5().getBbs(bbsID);
		BbsDAO5 BbsDAO5 = new BbsDAO5();
		BbsDAO5.viewPoint(bbs.getUserID());
	%>
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="../index.jsp">WebonDemandServiceNeed</a>
		</div>
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a href="../index.jsp">메인</a></li>
				<li class="active"><a href="sport">게시판</a></li>
			</ul>
			<%
				if(userID == null) {
			%>
	...
	<div class="container">
		<div class="row">
			...
			<a href="sport" class="btn btn-primary">목록</a>
			<%
